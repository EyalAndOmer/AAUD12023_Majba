...
namespace ds::amt {
    ...
    // POZOR !!
    // Dynamic cast sa da len nad referenciou alebo adresou
    // ked nepojde dynamic cast cez referenciu tak hodi vynimku
    // ak idem cez adresu tak nie, hodi nullptr namiesto vynimky
    ...
    {
        size_t result = 0;
        // ked dam & tak dam vsetko co je v danom blocku pristupne
