...
namespace ds::utils
{
    ...
    protected:
        ...
        // [[nodiscard]] vyhodi pri compile warning, pokial sa navratova hodnota danej funkcie bude ignorovat
        [[nodiscard]] size_t getRandomIndex() const;
        [[nodiscard]] int getRandomData() const;
    ...
    public:
        ...
        {
            // tieto typy sa nahradzaju za sablonove parametre
